            ...
            <div className="tab-inner-content mt-5 account">
              ...
              <div className="notice mt-5">
                ...
                <div className="notice__message">
                  <p>This is an awesome <a href="https://hieuhoccode.com/khoa-hoc-lap-trinh-mern-stack-100-du-an-thuc-te-chat-luong/" target="blank" style={{ 'textDecoration': 'none' }}>MERN Stack course</a> in the field of programming. This course teach everyone how to create a Trello web app clone.</p>
            ...
            <div className="tab-inner-content my-5 settings">
              ...
              <div className="notice mt-5">
                ...
                <div className="notice__message">
                  ...
                  <p>Author: <strong>hieuhoccode Official</strong></p>
                  <p>Blog: <a href="https://hieuhoccode.com" target="blank" style={{ 'textDecoration': 'none' }}>https://hieuhoccode.com</a></p>
                  <p>CV: <a href="https://cv.hieuhoccode.com" target="blank" style={{ 'textDecoration': 'none' }}>https://cv.hieuhoccode.com</a></p>
                  <p>Yoututbe: <a href="https://www.youtube.com/c/hieuhoccodeOfficial" target="blank" style={{ 'textDecoration': 'none' }}>https://www.youtube.com/c/hieuhoccodeOfficial</a></p>
                </div>
              </div>
            </div>
          </Tab>
